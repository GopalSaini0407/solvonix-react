...
export default function PortfolioContent() {
  ...
  {/* Right Side Section with Bigger Image */}
  <div className="w-full md:w-1/2 flex justify-center">
    <img alt="Design" className="w-full md:w-[90%] rounded-lg" src="images/dca.png" loading="lazy" />
  </div>
</div>

    <div className="p-6 pb-[80px] flex flex-col-reverse md:flex-row-reverse bg-[#FCC81C] md:me-20 mb-[80px]">
      {/* Left Side Section */}
      <div className="w-full md:w-1/2">
        <div className="text-left md:space-y-10 space-y-2 bg-[#FCC81C] flex flex-col justify-start md:justify-center items-center md:items-start md:h-100">
          <h2 className="md:text-2xl text-base font-semibold border-b-2 border-[#F58D31]">
          360trip 
          </h2>
          <h2 className="md:text-2xl text-base font-semibold">
          Its professionally  <br />
          managed travel engine     
               </h2>
          <button className="px-3 py-2 font-light border rounded text-base border-[#F48E32] md:text-3xl flex items-center">
            Go to Project 
            <svg
